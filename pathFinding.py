        ...
        if rN == 0: # 流云渡
            ...
            for rNN in range (node,4):
                ...
                if rNN == 0:
                    ...
                    aSequence = (['w',3.7],['d',1],['c'],['d',3],['c'],['CF'],['d',2],['c'],['CF'],['a',6],['w',3],['a',0.5],['s',0.5],['sp',2],['c'],['CF'],['w',1.4],['d',3.5],['w',1],['a',1],['w',2.7],['d',1],['s',0.5],['c'],['sp',2],['c'],['CF'],['m',1])
                cfg.action(aSequence)
                if DEBUG == 2:
                    return 1
        elif rN == 6: # 绥园
            for rNN in range (node,2):
                ...
                if rNN == 0: # 谈狐林后门
                    ...
                    aSequence = (['w',2],['aw',0.5],['dw',0.5],['w',2.3],['c'],['CF'],['d',2.6],['c'],['a',0.5],['s',1],['c'],['CF'],['w',0.8],['d',1],['c'],['CF'],['m',1])
                cfg.action(aSequence)
                if DEBUG == 2:
                    return 1
        elif rN == 7: # 丹鼎司
        ...
        if rN == 0: # 筑梦边境
            ...
            for rNN in range (node,9):
                ...
                if rNN == 0:
                    ...
                    aSequence = (['w',2],['a',1],['c'],['a',7.5],['w',2.3],['c'],['CF'],['dw',1.8],['c'],['CF'],['m',1])
                elif rNN == 2:
                    aSequence = (['w',2],['a',12],['sp',2],['a',4],['sp',2],['a',1.8],['f',3],['w',2.8,1],['c'],['CF'],['a',3.3],['c'],['CF'],['c'],['CF'],['w',1],['r',2],['w',0.3],['wa',0.5],['as',1],['c'],['CF'],['m',1],['qm'])
                elif rNN == 3:
                    aSequence = (['w',0.3,1],['d',2,1],['f',8],['w',6.2],['d',2],['c'],['CF'],['d',1.3],['s',1.8],['d',0.9],['s',4],['c'],['s',4],['f',8],['w',4.3],['a',5],['f',8],['w',1.8],['a',2.5],['w',1.5],['d',1],['s',1],['f',3],['w',4.5],['d',2],['w',0.2,1],
...
if __name__ == '__main__':
    ...
    #0开始
    selectRegion(3, 2, 8) # Debug哪个区域直接在这里修改
