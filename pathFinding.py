            ...
            if rN == 0: # 流云渡
                ...
                for rNN in range (node,3):
                    ...
                    if rNN == 0:
                        ...
                        aSequence = (['a',0.4],['w',0.8],['d',1.6],['w',1],['c'],['CF'],['w',2.7],['a',2.5],['s',2],['a',1],['c'],['CF'],['s',0.4],['a',0.5],['c'],['CF'],
                                     ...
                                     ['s',4.8],['d',0.5],['s',2],['d',1],['c'],['CF'],['c'],['m',1])
                    cfg.action(aSequence)
                    if DEBUG == 2:
                        return 1
            elif rN == 2: # 长乐天
                ...
                for rNN in range (node,4):
                    ...
                    if DEBUG == 1:
                        return 1
                    if rNN == 0:
                        aSequence = (['s', 2.5],['ds', 2.6],['c'],['CF'],['c'],['CF'],['sd', 0.8],['c'],['CF'],['as',3],['w',0.2],['c'],['CF'],['wa',0.3],['sa',0.2],['c'],['CF'],['m',1])
                    elif rNN == 1:
                        ...
                        aSequence = (['s', 9.2],['a',1.4],['s',1],['a',6.5],['c'],['CF'],['d',7],['c'],['CF'],['s',1],['c'],['CF'],['c'],['CF'],['d',2],['c'],['CF'],['c'],['CF'],['a',0.6],['s',4.8],['d',3.8],['c'],['c'],['CF'],['c'],['a',4],['s',2.5],['c'],['CF'],['c'],['CF'],['m',1])
                    cfg.action(aSequence)
                    if DEBUG == 2:
                        return 1
            elif rN == 5: # 工造司
                ...
                for rNN in range (node,6):
                    ...
                    if rNN == 0:
                        ...
                        aSequence = (['d',0.2],['w',6.2],['aw',3.2],['w',6.2],['a',4],['w',6],['wa',1],['c'],['as',1],['c'],['CF'],['m',1])
                    elif rNN == 4:
